<?php
	...
	$a = $_GET['id'];
	$query = mysqli_query($connect,  "SELECT * FROM printers where id = '$a'");
	...
	if(isset($_POST['submit'])){
		...
		$update_query = "UPDATE printers SET 
		name = '$name', 
		WHERE id= '$a';";
		$update = mysqli_query($connect, $update_query);
		if($update){ 
			$feedback = "Printer added succesfully";
    	...
    	<div class="container wow fadeInUp">
        	...
        	<div class="container">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <button class="btn waves-effect waves-light btn-flat" id="computer_btn" type="submit" name="submit">Update Printer name
                            <i class="material-icons right">keyboard_arrow_right</i>
                          </button>
                          
                          <a href="update_printer_image.php?id=<?php echo $a?>"><button class="btn waves-effect waves-light" type="button">Change Image
                            <i class="material-icons right">keyboard_arrow_right</i>
                          </button></a>
                        </div>
                        <div id="feedback">
