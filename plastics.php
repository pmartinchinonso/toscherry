<?php 
	...
	$page_query = "select count(*) from plastics order by id desc ";
	...
	$select = mysqli_query($connect, "SELECT * FROM plastics order by id desc $limit");
...
<body>
	...
	<section id="latest_computers">
    	<div class="container wow fadeInUp">
        	<div class="row">
                <div class="col s12">
                    <h3 class="section_title">Our Plastics</h3>
                    <div class="section_title_divider"></div>
                    <p class="section_desc">Below are the latest trending Plastics<br>
            ...
            <?php for($x = 0; $x <count($name); $x++){
            	...
            	<div class="latest_items_container col l4 m6 s12 wow fadeInUp" data-wow-delay="<?php echo $delay;?>">
                	<div class="latest_items  z-depth-1-half row">
                    	<div class="plastic_img_container col s6 m12"><img class="materialboxed plastic_img_container" data-caption="<?php echo $name[$x];?>" src="img/plastics/<?php echo $image[$x];?>" width="90%"></div>
        ...
        <div class="page_nav">
            ...
            echo "<a href='plastics.php?pageno=1'>First</a> | ";
            $prev_page = $page_no-1;
            echo " <a href='plastics.php?pageno=$prev_page'>Prev</a>";
            }
            ...
            $next_page = $page_no+1;
            echo "<a href='plastics.php?pageno=$next_page'>Next</a> | ";
            echo "<a href='plastics.php?pageno=$num_of_pages'>Last</a>";
            }
            ?>
        </div>
    </section>
